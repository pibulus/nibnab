...
3. Use the menubar icon or Ctrl+Cmd+N to view clips
...
Future updates will be thoughtful additions, not feature bloat. If it makes the app more complex, it probably doesn't belong.
